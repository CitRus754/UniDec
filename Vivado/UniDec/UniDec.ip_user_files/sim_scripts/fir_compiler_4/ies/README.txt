...
#
# Generated by export_simulation on Mon Oct 23 12:00:55 +0300 2023
#
################################################################################
...
'-reset_run' switch to the './fir_compiler_4.sh' script.

./fir_compiler_4.sh -reset_run
...
./fir_compiler_4.sh -noclean_files

For more information on the script, please type './fir_compiler_4.sh -help'.
