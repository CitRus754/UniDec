...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xbip_utils_v3_0_10 -L axi_utils_v2_0_6 -L fir_compiler_v7_2_15 -L xil_defaultlib -L secureip -L xpm --snapshot fir_compiler_4 xil_defaultlib.fir_compiler_4 -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim fir_compiler_4 -key {Behavioral:sim_1:Functional:fir_compiler_4} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb fir_compiler_4.wdb xsim.dir)
