...
#
# Generated by Vivado on Thu Oct 12 12:56:48 +0300 2023
...
# Script info
echo -e "fir_compiler_3.sh - Script generated by export_simulation (Vivado v2020.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xbip_utils_v3_0_10 -L axi_utils_v2_0_6 -L fir_compiler_v7_2_15 -L xil_defaultlib -L secureip -L xpm --snapshot fir_compiler_3 xil_defaultlib.fir_compiler_3 -log elaborate.log
}
