...
HD_PWD='E:/NTT/WorkingDirectory/09.23/Vivado/UniDec/UniDec.runs/fir_compiler_4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fir_compiler_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fir_compiler_4.tcl
